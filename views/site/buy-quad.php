...
$this->title = 'Skup uszkodzonych quadów' . ' - ' . Yii::$app->name;
                ...
                <div class="col-sm-8">
                    <div class="post">
                        <div class="post-thumbnail">
                            <img src="<?= Url::to('@web/images/quad-2.jpg') ?>" alt="Skup quadów">
                        </div>
                        ...
                        <div class="post-entry">
                            ...
                            <p>W ramach naszej działalności prowadzimy skup quadów wybranych marek.</p>
