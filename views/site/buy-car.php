...
$this->title = 'Skup uszkodzonych samochodów' . ' - ' . Yii::$app->name;
                ...
                <div class="col-sm-8">
                    <div class="post">
                        <div class="post-thumbnail">
                            <img src="<?= Url::to('@web/images/pexels-photo-1615548.jpeg') ?>" alt="Pomoc drogowa">
                        </div>
                        ...
                        <div class="post-entry">
                            ...
                            <p>W ramach naszej działalności prowadzimy skup samochodów wybranych marek.</p>
